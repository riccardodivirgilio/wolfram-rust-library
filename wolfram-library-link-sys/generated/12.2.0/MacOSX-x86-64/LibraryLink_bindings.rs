...
pub const LIBRARY_NO_ERROR: ::std::os::raw::c_uint = 0;
pub const LIBRARY_TYPE_ERROR: ::std::os::raw::c_uint = 1;
pub const LIBRARY_RANK_ERROR: ::std::os::raw::c_uint = 2;
pub const LIBRARY_DIMENSION_ERROR: ::std::os::raw::c_uint = 3;
pub const LIBRARY_NUMERICAL_ERROR: ::std::os::raw::c_uint = 4;
pub const LIBRARY_MEMORY_ERROR: ::std::os::raw::c_uint = 5;
pub const LIBRARY_FUNCTION_ERROR: ::std::os::raw::c_uint = 6;
pub const LIBRARY_VERSION_ERROR: ::std::os::raw::c_uint = 7;
