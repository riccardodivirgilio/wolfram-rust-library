...
pub fn array_type_to_wxf(dt: NumericArrayDataType) -> u8 {
    match dt {
        NumericArrayDataType::Bit8 => ARRAY_TYPE_INTEGER8,
        NumericArrayDataType::Bit16 => ARRAY_TYPE_INTEGER16,
        NumericArrayDataType::Bit32 => ARRAY_TYPE_INTEGER32,
        NumericArrayDataType::Bit64 => ARRAY_TYPE_INTEGER64,
        NumericArrayDataType::UBit8 => ARRAY_TYPE_UNSIGNED_INTEGER8,
        NumericArrayDataType::UBit16 => ARRAY_TYPE_UNSIGNED_INTEGER16,
        NumericArrayDataType::UBit32 => ARRAY_TYPE_UNSIGNED_INTEGER32,
        NumericArrayDataType::UBit64 => ARRAY_TYPE_UNSIGNED_INTEGER64,
...
pub fn array_type_from_wxf(byte: u8) -> Option<NumericArrayDataType> {
    Some(match byte {
        ARRAY_TYPE_INTEGER8 => NumericArrayDataType::Bit8,
        ARRAY_TYPE_INTEGER16 => NumericArrayDataType::Bit16,
        ARRAY_TYPE_INTEGER32 => NumericArrayDataType::Bit32,
        ARRAY_TYPE_INTEGER64 => NumericArrayDataType::Bit64,
        ARRAY_TYPE_UNSIGNED_INTEGER8 => NumericArrayDataType::UBit8,
        ARRAY_TYPE_UNSIGNED_INTEGER16 => NumericArrayDataType::UBit16,
        ARRAY_TYPE_UNSIGNED_INTEGER32 => NumericArrayDataType::UBit32,
        ARRAY_TYPE_UNSIGNED_INTEGER64 => NumericArrayDataType::UBit64,
