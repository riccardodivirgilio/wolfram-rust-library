...
[Wolfram Research](https://github.com/wolframresearch) repositories on GitHub.

## Licensing of Contributions

By contributing to Wolfram, you agree and affirm that:

> Wolfram may release your contribution under the terms of the [MIT license](https://opensource.org/licenses/MIT)
> AND the [Apache 2.0 license](https://opensource.org/licenses/Apache-2.0); and
...
thoroughness of your report will positively correlate with our ability to address it**.
